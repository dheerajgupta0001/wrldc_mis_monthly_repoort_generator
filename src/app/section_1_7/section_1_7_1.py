...
def fetchSection1_7_1Context(appDbConnStr: str, startDt: dt.datetime, endDt: dt.datetime) -> ISection_1_7_1:
    ...
    lessVoltPercData = mRepo.getDailyVoltDataByLevel(
        765, "%Time <380 or 728", startDt, endDt)
    ...
    bandVoltPercData = mRepo.getDailyVoltDataByLevel(
        765, "%Time within IEGC Band", startDt, endDt)
...
def strip765(nStr: str):
    return nStr.replace(' - 765KV', '')
