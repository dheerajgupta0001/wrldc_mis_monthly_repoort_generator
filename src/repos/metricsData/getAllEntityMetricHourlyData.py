...
def getAllEntityMaxMetricDataFromHourly(appDbConnStr: str, metricName: str, startDt: dt.datetime, endDt: dt.datetime) -> List[IMetricsDataRecord]:
    ...
    metricsFetchSql = """
            ...
            group by sfh.entity_tag
            order by sfh.entity_tag asc
        """
